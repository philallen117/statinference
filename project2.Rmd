...
There are `r dim(ToothGrowth)[1]` observations in a between groups experiment, varying both the dose of vitamin C (ascorbic acid) and the form in which the supplement is added to the basal diet: as orange juice or directly as vitamin C.
...
There is weak evidence to reject the hull hypothesis that the form of supplement makes no difference to growth, with p = `r round(100*ttig95$p.value,3)`%. The 95% confidence interval for the difference of the means (Vitamin C minus Orange Juice) not containing zero: `r ci(ttig95)`. However, the 90% confidence interval _does_ include zero: `r ci(ttig90)`.
